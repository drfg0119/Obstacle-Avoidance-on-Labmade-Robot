...
;//! \htmlinclude Apl_kai.msg.html

(cl:defclass <Apl_kai> (roslisp-msg-protocol:ros-message)
  ((obs_dist
    :reader obs_dist
    :initarg :obs_dist
    :type cl:fixnum
...
(cl:defclass Apl_kai (<Apl_kai>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Apl_kai>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Apl_kai)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name relative_angle_nb-msg:<Apl_kai> is deprecated: use relative_angle_nb-msg:Apl_kai instead.")))

(cl:ensure-generic-function 'obs_dist-val :lambda-list '(m))
(cl:defmethod obs_dist-val ((m <Apl_kai>))
...
(cl:defmethod obs_direct-val ((m <Apl_kai>))
...
(cl:defmethod goal_x-val ((m <Apl_kai>))
...
(cl:defmethod goal_y-val ((m <Apl_kai>))
...
(cl:defmethod obs_latelitude-val ((m <Apl_kai>))
  ...
  (obs_latelitude m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Apl_kai>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Apl_kai>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Apl_kai>)))
  "Returns string type for a message object of type '<Apl_kai>"
  "relative_angle_nb/Apl_kai")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Apl_kai)))
  "Returns string type for a message object of type 'Apl_kai"
  "relative_angle_nb/Apl_kai")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Apl_kai>)))
  "Returns md5sum for a message object of type '<Apl_kai>"
  "9809d650616fd3c284b0b4b27cd2e9fe")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Apl_kai)))
  "Returns md5sum for a message object of type 'Apl_kai"
  "9809d650616fd3c284b0b4b27cd2e9fe")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Apl_kai>)))
  "Returns full string definition for message of type '<Apl_kai>"
  (cl:format cl:nil "uint16 obs_dist~%float32 obs_direct~%float32 goal_x~%float32 goal_y~%int32 obs_latelitude~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Apl_kai)))
  "Returns full string definition for message of type 'Apl_kai"
  (cl:format cl:nil "uint16 obs_dist~%float32 obs_direct~%float32 goal_x~%float32 goal_y~%int32 obs_latelitude~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Apl_kai>))
  (cl:+ 0
     2
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Apl_kai>))
